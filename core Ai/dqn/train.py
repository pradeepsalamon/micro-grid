...
================================
Trains a Deep Q-Network (DQN) agent on the MicrogridEnv
...
Output:
    dqn_model.zip     — saved policy checkpoint
...
def train():
    ...
    print("\n✅  Training complete.  Model saved →  dqn_model.zip")
